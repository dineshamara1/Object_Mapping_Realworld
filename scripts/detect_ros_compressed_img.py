...
class Detector:
    ...
    def __init__(self):
        ...
        #Defining the topics
        self.image_topic = "/camera1/compressed"
        self.depth_topic = "/zed2/zed_node/depth/depth_registered"
        self.camera_frame = "camera_link"
        self.camera_topic = "/zed2/zed_node/depth/camera_info"
        self.object_detect = "/object_detected_image"
        self.marker_topic= "visualization_marker_array"

        self.image_pub = rospy.Publisher(self.object_detect,Image, queue_size=1)
        self.bridge = CvBridge()
        self.image_sub = rospy.Subscriber(self.image_topic, CompressedImage, self.image_cb, queue_size=1, buff_size=2**24)
    ...
    def image_cb(self, data):
        ...
        if num_detections >=1:           
            ...
            for i in range(len(objects)):
                ...
                self.object_wrt_world = self.uv_to_xyz(cx, cy)
                #print(self.object_wrt_world.point)
